...
export default function Home() {
  ...
  if (showDemographics) {
    return (
      <div className="flex flex-col min-h-dvh p-6 justify-center">
        <h2 className="text-2xl font-bold mb-2 text-center">간단한 정보</h2>
        ...
        <div className="space-y-5 mb-8">
          <div>
            <label className="text-base text-neutral-500 mb-1 block">나이</label>
            <input
              type="number"
              placeholder="예: 27"
              value={age}
          ...
          <div>
            <label className="text-base text-neutral-500 mb-2 block">성별</label>
            <div className="flex gap-2">
              {['남성', '여성', '기타', '응답 안 함'].map((g) => (
                <button
                  key={g}
                  onClick={() => setGender(g)}
                  className={`flex-1 py-3 rounded-xl text-base border-2 transition-colors ${
                    gender === g
          ...
          <div>
            <label className="text-base text-neutral-500 mb-2 block">대학원 몇 학기째</label>
            <div className="flex gap-2">
              {['0', '1', '2', '3', '4+'].map((s) => (
                <button
                  key={s}
        ...
        <button
          onClick={handleSkip}
          className="w-full py-3 text-neutral-400 text-base active:scale-95 transition-transform"
        >
          건너뛰기
        </button>
      </div>
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-dvh p-6 text-center">
      ...
      <p className="text-xl text-neutral-500 mb-1">HEXACO 성격 테스트</p>
      <p className="text-base text-neutral-400 mb-8">약 5분 소요 · 24문항</p>

      <p className="text-base text-neutral-400 max-w-[300px] mb-8 leading-relaxed">
